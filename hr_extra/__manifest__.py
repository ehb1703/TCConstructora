# -*- coding: utf-8 -*-
{
    ...
    'installable': True,
    'application': True,
    'depends': ['hr_payroll', 'hr_contract', 'hr_holidays', 'hr_attendance', 'l10n_mx_hr', 'l10n_mx_hr_payroll_localisation', 'hr_work_entry', 'hr_timesheet', 'project', 'project_extra'],
    'data': [
        'data/ir_cron_attendance.xml',
        'data/ir_sequence.xml',
        'data/hr_leave_paternidad.xml',
        'data/hr_work_entry_type_domtrab.xml',
        ...
        'views/hr_payslip_employees_obra_views.xml',
