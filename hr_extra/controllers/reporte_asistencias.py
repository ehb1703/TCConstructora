...
class ControllerReporteAsistencias(http.Controller):
    ...
    def hr_reporte_asistencias(self, wizard_id, **kw):
        ...
        # Restricción por encargado de nómina según tipo del usuario activo.
        ...
        for col, ancho in enumerate([35, 25, 25, 30, 15, 18, 18, 15]):
        ...
        # Fila 1: Título
        ws.merge_range(0, 0, 0, 7, 'Reporte de asistencia de personal', fmt_titulo)
        # Fila 2: Periodo
        ...
        # Fila 3: Encabezados
        for col, nombre in enumerate(['Nombre', 'Departamento', 'Puesto', 'Obra', 'Fecha', 'Hora de Entrada', 'Hora de Salida', 'Tiempo Extra']):
